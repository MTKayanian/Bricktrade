...
import "./Individual_profile_overview.css";
...
class Individual_profile_overview extends  Component{
	constructor(props) {
		super(props);
		this.state = {
			  		...
			  		<div className="col-lg-5 mt-4">
			   			<div className="profile-section h-100">
			   				<div className="clearfix pb-4">
		   						<div className="float-left"><h3 className="head-main">Personal Profile</h3></div>
			   		...
			   		<div className="col-lg-5 mt-4">
			   			<div className="profile-section h-100">
			   				<div className="clearfix pb-2">
		   						<div className="float-left"><h3 className="head-main">Personal Address</h3></div>
			  	...
			  	<div className="row">
			  		...
			  		<div className="col-lg-5 mt-4">
			  			<div className="profile-section h-100 p-0 position-relative">
		   					...
		   					<div className="pl-32">
		   						<p className="m-0 fs-14">Timezone</p>
		   						<h3 className="mb-10 sub-head">GMT-08:00</h3>
		   						<p className="m-0 fs-14">Nationality</p>
		   						<h3 className="mb-10 sub-head">United Kingdom</h3>
		   						<p className="m-0 fs-14">Personal ID</p>
		   						<h3 className="mb-10 sub-head">HU798784HGSNB</h3>
								<p className="m-0 fs-14">Passport</p>
		   						<h3 className="mb-10 sub-head">___________</h3>
		   						<form>
...
const mapStateToProps = state => ({
  ...
  export default connect(mapStateToProps)(Individual_profile_overview);
